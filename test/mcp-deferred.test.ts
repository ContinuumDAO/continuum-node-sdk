...
test('classifyDefiToolPack splits continuum-dao, hyperliquid, and uniswap packs', () => {
	...
	assert.equal(classifyDefiToolPack('ctm_continuum_dao_fetch_proposal_votes'), 'governance-read');
	assert.equal(classifyDefiToolPack('ctm_continuum_dao_simulate_proposal'), 'governance-write');
	assert.equal(classifyDefiToolPack('ctm_continuum_dao_compose_proposal_action'), 'governance-write');
	assert.equal(classifyDefiToolPack('ctm_continuum_dao_build_approve_multisign'), 'governance-write');
	assert.equal(classifyDefiToolPack('ctm_continuum_dao_marketplace_fee_alternative'), 'market-data');
	assert.equal(classifyDefiToolPack('ctm_continuum_dao_marketplace_search'), 'market-data');
	assert.equal(classifyDefiToolPack('ctm_continuum_dao_marketplace_fetch_listings'), 'governance-read');
	...
	assert.equal(classifyDefiToolPack('ctm_morpho_build_blue_supply_multisign'), 'lend');
	assert.equal(classifyDefiToolPack('ctm_morpho_build_blue_withdraw_multisign'), 'lend');
	assert.equal(classifyDefiToolPack('ctm_morpho_build_blue_collateral_withdraw_multisign'), 'blue');
	assert.equal(classifyDefiToolPack('ctm_morpho_fetch_stock_markets'), 'lend');
	assert.equal(classifyDefiToolPack('ctm_morpho_build_midnight_lend_offer_multisign'), 'lend');
	assert.equal(classifyDefiToolPack('ctm_morpho_build_midnight_cancel_lend_offer_multisign'), 'lend');
	assert.equal(classifyDefiToolPack('ctm_morpho_build_midnight_borrow_multisign'), 'midnight');
	assert.equal(classifyDefiToolPack('ctm_morpho_build_merkl_claim_multisign'), 'rewards');
	assert.equal(classifyDefiToolPack('ctm_morpho_fetch_merkl_rewards'), 'rewards');
	assert.equal(classifyDefiToolPack('ctm_aave_v4_fetch_merkl_rewards'), 'rewards');
	assert.equal(classifyDefiToolPack('ctm_aave_v4_build_merkl_claim_multisign'), 'rewards');
	assert.equal(classifyDefiToolPack('ctm_euler_v2_fetch_merkl_rewards'), 'rewards');
	assert.equal(classifyDefiToolPack('ctm_euler_v2_build_merkl_claim_multisign'), 'rewards');
