export const OHLCV_TRUNCATION_MYTH =
	...
	'Chart display downsamples via maxPoints across the full loaded window; meta.loadStatus.barCount is the loaded bar count and meta.loadStatus.displayBarCount is the rendered point count. ' +
